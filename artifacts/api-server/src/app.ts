...
// Serve static files from public directory (generated by Vite at root)
// In development: __dirname/../../../public (artifact → api-server → dist → root)
// In Vercel: Vercel serves public/ automatically; fallback to process.cwd()

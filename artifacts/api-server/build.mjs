...
async function buildAll() {
  ...
  // Note: public/ is now generated by Vite in the root directory,
  // not in the api-server, so we don't need to copy it here.
  // Vercel serves /public/* as static assets automatically.
